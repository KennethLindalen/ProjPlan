...
import dev.kennethlindalen.domain.Document;
import dev.kennethlindalen.repository.DocumentRepository;
...
/**
 * REST controller for managing {@link dev.kennethlindalen.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
