...
import dev.kennethlindalen.domain.Project;
import dev.kennethlindalen.repository.ProjectRepository;
...
/**
 * REST controller for managing {@link dev.kennethlindalen.domain.Project}.
 */
@RestController
@RequestMapping("/api")
@Transactional
