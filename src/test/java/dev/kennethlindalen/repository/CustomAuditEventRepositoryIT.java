...
import dev.kennethlindalen.config.audit.AuditEventConverter;
import dev.kennethlindalen.domain.PersistentAuditEvent;
...
import static dev.kennethlindalen.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
